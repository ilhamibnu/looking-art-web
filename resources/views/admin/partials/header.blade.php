<div class="nk-header nk-header-fixed is-light">
    <div class="container-fluid">
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none"><a href="index.html" class="logo-link"><img class="logo-light logo-img" src="images/logo.png" srcset="images/logo2x.png 2x" alt="logo"><img class="logo-dark logo-img" src="images/logo-dark.png" srcset="images/logo-dark2x.png 2x" alt="logo-dark"></a></div>
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                    ...
                    <li class="dropdown chats-dropdown hide-mb-xs"><a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                            ...
                            <div class="dropdown-body">
                                <ul class="chat-list">
                                    ...
                                    <li class="chat-item is-unread"><a class="chat-link" href="apps-chats.html">
                            ...
                            <div class="dropdown-foot center"><a href="apps-chats.html">View All</a></div>
                        </div>
                    </li>
